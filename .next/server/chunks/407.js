...
exports.Routes = {
  About: (query) => ({ pathname: "/Aboutme", query }),
  Introduction: (query) => ({ pathname: "/Introduction", query }),
  Projects: (query) => ({ pathname: "/Projects", query }),
  TechStack: (query) => ({ pathname: "/TechStack", query }),
